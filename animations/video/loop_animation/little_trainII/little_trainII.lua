...
function LittleTrainII:init(context)
...
function LittleTrainII:clear(context)
...
function LittleTrainII:setDuration(filter, duration)
    self.duration = duration
end

function LittleTrainII:seek(filter, timestamp)
    self.timestamp = timestamp
end

function LittleTrainII:apply(filter)
    filter.animation.params.renderToRT = true
end

function LittleTrainII:AnimateParam(progress)
...
function LittleTrainII:applyEffect(filter, outTex)
