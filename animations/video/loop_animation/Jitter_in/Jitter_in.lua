...
function JitterIn:init(context)
...
function JitterIn:clear(context)
...
function JitterIn:setDuration(filter, duration)
    self.duration = duration
end

function JitterIn:seek(filter, timestamp)
    self.timestamp = timestamp
end

function JitterIn:apply(filter)
    filter.animation.params.renderToRT = true
end

function JitterIn:AnimateParam(progress)
...
function JitterIn:applyEffect(filter, outTex)
