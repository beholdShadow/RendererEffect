...
function LittleTrain:init(context)
...
function LittleTrain:clear(context)
...
function LittleTrain:setDuration(filter, duration)
    self.duration = duration
end

function LittleTrain:seek(filter, timestamp)
    self.timestamp = timestamp
end

function LittleTrain:apply(filter)
    filter.animation.params.renderToRT = true
end

function LittleTrain:AnimateParam(progress)
...
function LittleTrain:applyEffect(filter, outTex)
