...
function Pendulum:apply(filter, outTex) 
    ...
    local mvpMat = Matrix4f:TransMat(lineInfo.maxLineWidth / 2.0, lineInfo.maxLineHeight, 0.0) *
                    rotMat *
                Matrix4f:TransMat(-lineInfo.maxLineWidth / 2.0, - lineInfo.maxLineHeight, 0.0)
...
function Pendulum:applyEffect(label, srcTex, dstTex)
