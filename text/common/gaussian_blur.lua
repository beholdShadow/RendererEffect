...
function gaussBlurRender:draw(context, inTex, outTex)
    ...
    local cache_tex = context:getTexture(PixelSize.new(width, height, outTex.pixelScale))
    local out_tex = context:getTexture(PixelSize.new(width, height, outTex.pixelScale))
